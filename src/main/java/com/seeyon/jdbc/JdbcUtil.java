...
public class JdbcUtil {
    ...
    //数据库密码
    private static final String PASSWORD = "yy926498";
    //驱动信息
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    //数据库地址
    private static final String URL = "jdbc:mysql://10.211.55.3:3306/type";
...
//        String sql = "insert into user(userName,userAge,userAddress) values ('yangyu',28,'chengdu')";

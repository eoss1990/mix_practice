...
public class DynamicEngine {
    ...
    public Object javaCodeToObject(String fullClassName, String javaCode) throws Exception {
        ...
        if (success) {
            ...
            //编译后生成class文件---------------------
            String classPath = Thread.currentThread().getContextClassLoader().getResource("").getPath()+fullClassName.replace(".","/")+".class";
            FileOutputStream fileOut = new FileOutputStream(classPath);
            fileOut.write(jco.getBytes());
            fileOut.flush();
            fileOut.close();
